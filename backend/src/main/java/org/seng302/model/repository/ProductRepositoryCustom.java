...
public interface ProductRepositoryCustom {
     ...
     */
    Page<Product> findAllProductsByBusinessIdAndIncludedFields(List<String> search,
                                                               List<String> fields,
                                                               Integer businessId,
                                                               Pageable pageable);
     ...
     * @return Page of Products by search criteria
     */
    Page<Product> findAllProductsByBusinessIdAndIncludedFieldsAndBarcode(List<String> search,
                                                                         List<String> fields,
                                                                         Integer businessId,
                                                                         Pageable pageable,
                                                                         String barcode);
