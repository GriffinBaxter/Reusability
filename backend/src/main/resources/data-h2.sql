...
/* Users (20) */
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Alex', 'Doe', 'Joe', 'Johnny', 'Biography', 'emailUSER@email.com', DATE'2008-02-02', '0271317', 5, 'UGFzc3dvcmQxMjMh', DATE'2021-02-12', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Chad', 'Taylor', 'S', 'Chaddy', 'Biography', 'chad.taylor@example.com', DATE'2006-02-01', '0271316678', 3, 'UGFzc3dvcmQxMjMh', DATE'2021-03-14', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Naomi', 'Wilson', 'I', 'GM', 'Biography', 'naomi.wilson@example.com', DATE'2007-09-08', '54335522', 4, 'UGFzc3dvcmQxMjMh', DATE'2021-03-01', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Seth', 'Murphy', 'S', 'Sethy', 'Biography', 'seth.murphy@example.com', DATE'2003-06-19', '027188316', 5, 'UGFzc3dvcmQxMjMh', DATE'2021-03-03', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Minttu', 'Wainio', 'Anna', 'Minnie', 'Biography', 'minttu.wainio@example.com', DATE'2004-07-28', '0290316', 6, 'UGFzc3dvcmQxMjMh', DATE'2021-03-05', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Francisca', 'Benitez', 'Tina', 'Fran', 'Biography', 'francisca.benitez@example.com', DATE'2008-09-10', '12334456', 7, 'UGFzc3dvcmQxMjMh', DATE'2021-01-08', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Francisca', 'Bznitez', 'Tessa', 'Fran', 'Biography', 'francisca.bznitez@example.com', DATE'2001-07-17', '967352531', 8, 'UGFzc3dvcmQxMjMh', DATE'2021-01-01', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Frank', 'Smith', 'J', 'Frankie', 'Biography', 'frank.j.smith@email.com', DATE'2000-05-14', '0271316', 1, 'UGFzc3dvcmQxMjMh', DATE'2019-05-14', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Lina', 'Patterson', 'Jose Mari', 'Lina', 'Da', 'linap@email.com', DATE'2000-02-14', '0275431316', 9, 'UGFzc3dvcmQxMjMh', DATE'2010-05-14', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Evelia', 'Blanxart', 'Robert', 'Robby', 'I like art!', 'everblanxart@gmail.com', DATE'2007-04-13', '0272331323', 10, 'UGFzc3dvcmQxMjMh', DATE'2019-05-20', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Mirta', 'Lovel', 'Juan', 'Love', 'Pancakes', 'mjl25@uclive.ac.nz', DATE'1999-02-22', '0273321116', 11, 'UGFzc3dvcmQxMjMh', DATE'2021-01-20', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Jordan', 'Piper', 'Mervyn', 'Bag', 'I do not play the bagpipes!', 'jordanpiper@yahoo.com', DATE'2005-01-22', '0272121116', 12, 'UGFzc3dvcmQxMjMh', DATE'2019-05-22', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Ife', 'Weston', 'Missie', 'Missie', 'Miss me.', 'missie@gmail.com', DATE'2004-05-17', '0271316323', 13, 'UGFzc3dvcmQxMjMh', DATE'2014-02-14', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Pia', 'Kemp', 'Alex', 'Hemp', 'My cool bio.', 'piakemp13@email.com', DATE'2008-01-13', '0271316231', 14, 'UGFzc3dvcmQxMjMh', DATE'2020-01-12', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Alyce', 'Gibbs', 'Teddie', 'Teddie', 'Looking for cheap teddies.', 'alycegibbs@gmail.com', DATE'1965-02-19', '0271316943', 15, 'UGFzc3dvcmQxMjMh', DATE'2019-03-28', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Casandra', 'Dane', 'Fen', 'Cassie', 'I am not from Denmark!', 'cassie@dane.com', DATE'1982-01-17', '0271316226', 16, 'UGFzc3dvcmQxMjMh', DATE'2018-12-13', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Bennett', 'Garner', 'Finola', 'Garnish', 'I like apples.', 'garnish@yahoo.com', DATE'1989-09-12', '0271316096', 17, 'UGFzc3dvcmQxMjMh', DATE'2021-02-02', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Da', 'Meadows', 'Randolf', 'Da Baby', 'Looking for cheap bread.', 'dababy@email.com', DATE'2006-02-18', '0271316989', 18, 'UGFzc3dvcmQxMjMh', DATE'2019-12-12', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Tanner', 'Ilene', 'Levitt', 'Levy', 'Biography', 'tannerlevitt@gmail.com', DATE'1999-12-14', '0271316234', 19, 'UGFzc3dvcmQxMjMh', DATE'2020-01-12', 'USER', 3, null);
INSERT INTO `user` (first_name, last_name, middle_name, nickname, bio, email, date_of_birth, phone_number, address_id, password, created, role, remaining_login_attempts, time_when_unlocked) VALUES ('Juliana', 'Haden', 'Celeste', 'Jules', 'Biography', 'jules@email.com', DATE'2000-05-19', '0271316534', 20, 'UGFzc3dvcmQxMjMh', DATE'2021-02-03', 'USER', 3, null);
...
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (1, 'WANTED', DATE'2021-05-12', DATE'2021-06-19', 'PS5', 'I want a ps5.');
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (2, 'WANTED', DATE'2021-05-12', DATE'2021-01-19', 'IPHONE13', 'If exist right now, hhhh!');
...
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (2, 'EXCHANGE', DATE'2021-05-08', DATE'2022-05-15', 'Tinned Peaches for Tinned Apricots', 'Looking to exchange a tin of peaches for a tin of apricots. Bought by mistake.');
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (2, 'EXCHANGE', DATE'2021-05-01', DATE'2022-05-08', 'Whiskers Cat Food', 'Looking to exchange a 1KG bag of Whiskers cat biscuits for any other brand of cat biscuits.');
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (3, 'EXCHANGE', DATE'2021-05-13', DATE'2022-05-20', '1L Unsweetened Almond Milk', 'Looking to exchange a 1L bottle of unsweetened almond milk for original almond milk. Unopened.');
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (3, 'EXCHANGE', DATE'2021-05-12', DATE'2022-05-19', 'Hot Fuzz DVD', 'Looking to exchange Hot Fuzz DVD for another movie. Open to any offers.');
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (4, 'EXCHANGE', DATE'2021-05-11', DATE'2022-05-18', 'Freshly Caught Salmon', 'Looking to exchange some freshly caught salmon for some trout. I have 10 salmon available, make me an exchange offer if you have any freshly caught trout.');
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (4, 'EXCHANGE', DATE'2021-05-02', DATE'2022-05-09', '12 Banana Muffins', 'Looking to exchange banana muffins for other baked goods. I have 12 available, will exchange for 12 of the same baked good or for a variety.');
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (5, 'EXCHANGE', DATE'2021-05-12', DATE'2022-05-19', 'Pokemon Ruby for Pokemon Sapphire', 'Looking to exchange Pokemon Ruby for Pokemon Sapphire. Open to a permanent or temporary trade.');
INSERT INTO `marketplace_card` (creator_id, section, created, display_period_end, title, description) VALUES (6, 'EXCHANGE', DATE'2021-05-13', DATE'2022-05-20', '20 Feijoa', 'Looking to exchange feijoa for other fruit, preferably peaches. Homegrown and organic.');
