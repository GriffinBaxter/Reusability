    ...
    <nav id="navbar">
      <div id="navbar-content">
        ...
        <div id="user-section">
          ...
          <div>
            <svg style="margin: 0 0.4em; cursor: pointer" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-chat" viewBox="0 0 16 16" @click="toggleMessages">
