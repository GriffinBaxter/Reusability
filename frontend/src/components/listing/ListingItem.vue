      ...
      <div class="row" id="mainContent">
        <div class="col-12 col-sm-3">
          <div class="ratio ratio-4x3">
            <div v-if="this.$props.images.length > 0" id="carousel-item-images" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner">
                <div v-for="image of this.$props.images" v-bind:key="image.id" :class="image.isPrimary ? 'carousel-item active' : 'carousel-item'">
                  <img :src="getImageSrc(image.thumbnailFilename)" class="d-block w-100" width="195px" height="195px" alt="listing item image">
                </div>
              </div>
            ...
            <div v-else>
              <img :src="require('../../../public/default-product.jpg')" id="listing-item-image" alt="listing item image" width="195px" height="195px">
            </div>
          </div>
        </div>
        <div class="col">
