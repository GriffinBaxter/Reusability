    ...
    <div class="modal fade" ref="createCardModal" id="create-card-modal" tabindex="0">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <EditCreateCardModal currentModal="create" ref="editCreateModal" v-bind:type="type"/>
...
export default {
  ...
  methods: {
    showModal(event) {
      ...
      this.$refs.editCreateModal.resetData()
      this.modal.show()
    },
    hideModal() {
      this.modal.hide()
    ...
    createNewCard(event) {
      event.preventDefault()
      this.$refs.editCreateModal.createNewCard();
    }
  },
  mounted() {
