<template>
  <div>
    ...
    <DeleteConversationModal ref="deleteConversationModal" :id="conversationId" :user-name="userName"/>
    <!-- Conversation -->
  <div class="message-option">
    ...
    <div class="delete-icon-wrap" @click="(event) => { this.$refs.deleteConversationModal.showModal(event); }">
