<template>
  <div style="max-width: 950px" class="mx-auto">
    ...
    <div class="box" v-else>
      <div class="wrapper">
        <div class="left-side">
          <div class="total-header" id="total-sales">Weekly Sales: {{totalSales}}</div>
          <div class="total-header" id="total-revenue">Weekly Revenue: {{currencySymbol}}{{totalRevenue.toFixed(2)}} {{currencyCode}}</div>
        </div>
