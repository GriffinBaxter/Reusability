...
// This is used for API call to edit the user
export class EditUser {
    ...
    constructor({firstName, lastName, middleName, nickname, bio, email, dateOfBirth, phoneNumber, homeAddress, currentPassword, newPassword}) {
        this.data = {
            firstName,
            lastName,
            middleName,
